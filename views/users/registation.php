    ...
    <div class="container">
        <div class="row">
            ...
            <form class="col-xs-4 col-xs-offset-4" method="post" action="#">
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="Учебная группа" required id="group_name" name="group_name"/>
                </div>
                <div class="form-group">
                    <input class="form-control" placeholder="Почта" required type="email" id="email" name="email"/>
                </div>
                <div class="form-group">
                    <input class="form-control" type="password" placeholder="Пароль" id="password" name="password" required />
                </div>
                <div class="form-group">
                    <input class="form-control" type="password" placeholder="Повторите пароль" name="re_password" required id="re_password" />
                </div>
