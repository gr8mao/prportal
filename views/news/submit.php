...
$title = 'Добавить новость | PR-портал';
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="mg-md tc-white">
                    <span class="feather-icon icon-outbox"></span> Добавить новость
                </h1>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <form id="form" method="post" action="#" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input id="header" name="header" class="form-control" type="text"/>
                            </div>
                            <div class="form-group">
                                <label for="text">
                                    Текст новости
                                </label><textarea id="text" name="text" class="form-control" rows="4" cols="50" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="radio-inline"><input type="radio" name="location" value="World">Мировая</label>
                                <label class="radio-inline"><input type="radio" name="location" value="Russia">Российская</label>
                            </div>
                            <div class="form-group">
                                <label for="file">
                                    Обложка
