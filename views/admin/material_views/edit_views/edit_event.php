...
$title = 'Изменить событие | PR-портал';
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="mg-md tc-white">
                        <span class="feather-icon icon-outbox"></span> Изменить информацию о событии
                    </h1>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <form id="form" method="post" action="#" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" class="form-control" type="text" value="<?echo $event['Name'];?>"/>
                                </div>
                                <div class="form-group">
                                    <label for="place">
                                        Место проведения
                                    </label>
                                    <input id="place" name="place" class="form-control" type="text" value="<?echo $event['Place'];?>"/>
                                </div>
                                <div class="form-group">
                                    <label for="link">
                                        Ссылка на сайт мероприятия
                                    </label>
                                    <input id="link" name="link" class="form-control" type="text" value="<?echo $event['Link'];?>"/>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class='input-group date' id='datetimepicker1'>
                                            <input type='text' class="form-control" name="Date_start" id="Date_start" value="<?echo $event['Date_start'];?>"/>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class='input-group date' id='datetimepicker2'>
                                            <input type='text' class="form-control" name="Date_end" id="Date_end" value="<?echo $event['Date_end'];?>"/>
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                        </div>
                                ...
                                <div class="form-group" style="padding-top: 10px;">
                                    <label for="content">
                                        Аннотация мероприятия
                                                      ...
                                                      cols="50" required><?echo $event['Annotation'];?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="file">
                                        Обложка
